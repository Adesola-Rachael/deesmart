...
$(document).on('click', '.AddNewTestimonial',function(){
  var testimonial=new FormData($("#testimonial")[0]);
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      if(response.status==200){
        $('#Testimonial_success_message').html(
...
//     $.ajax({
//       type: "GET",
//       url:"/delete-course/"+delete_course_id,
