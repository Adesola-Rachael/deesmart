    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="title" placeholder="Enter The Event Title" id="event_title" class="event_title form-control">
            <!-- <input type="text" name="event" id="event" class="event form-control"> -->
        </div> 
        <div class="form-group mb-3">
            <label for="name">event Description</label>
            <textarea name="desc" id="event_desc" placeholder="Enter The Event Description" col="5" class="event_descform-control"></textarea>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input  type="datetime-local" id="Test_DatetimeLocal" name="date" id="date"  class="date">
        </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary AddNewevent">Save</button>
      </div>
      </form>
    </div>
  </div>
