<!-- Authors Modal -->
<div class="modal fade" id="AddTestimonialModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="name" placeholder="Enter The name " id="name" class="name form-control">
            <!-- <input type="text" name="event" id="event" class="event form-control"> -->
        </div> 
        <div class="form-group mb-3">
            <label for="role"> Role</label>
            <input type="text" name="role" placeholder="Enter The Role " id="role" class="role form-control">
        </div>
        <div class="form-group mb-3">
            <label for="desc"> Description</label>
            <textarea type="text" name="desc" placeholder="Enter The Description " id="desc" class="desc form-control"></textarea>
        </div>

        <div class="form-group mb-3">
            <label for="name"> Image of Testifier</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary AddNewTestimonial">Save</button>
      </div>
      </form>
    </div>
  </div>
