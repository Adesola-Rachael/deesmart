        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch" style="background:#e59560">
            <div class="content" style="background:#e59560">
              <h3 style="color:#fff;">Why Choose Mentor?</h3>
              <p style="color:#fff;">
...
<a href="{{url ('book_details/'.$book->id) }}"><img src="{{ Storage::url($book->book_cover) }}" alt=""></a>
</div>
...
<p style="background:">By Evan Winter</p>
<div class="price">
<span>$50.00</span>
</div>
<div class="review">
...
<div class="properties-card">
<div class="properties-img">
<a href="{{url ('book_details/'.$book->book_id) }}"><img src="{{ Storage::url($book->book_cover) }}" alt=""></a>
</div>
<div class="properties-caption properties-caption2">
<h3><a href="{{url ('book_details/'.$book->id) }}">{{ucfirst($book->course_title)}}</a></h3>
<p class="cat">{{ucfirst($book->category->category ?? 'None' )}}</p>
