@extends('../../layouts.adminCon')
    ...
    <div class="app-wrapper">
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <div class="col-auto">
								<h3 class="btn app-btn-primary" id="addcourse" style="float:right">Add New Course</h3>

								    <!-- <a class="btn app-btn-primary" href="#">Upload File</a> -->
							    </div>
						    </div><!--//row-->
					    </div><!--//table-utilities-->
				    </div><!--//col-auto-->
			    </div><!--//row-->
				<div class="col-md-12" id="course_success_message" ></div>
					    ...
					    <div class="app-card app-card-doc shadow-sm h-100">
						    <div class="app-card-thumb-holder p-3">
								...
								<div class="app-card-thumb">
	                                <img class="thumb-image" src="{{$course->course_img_link}}" alt="">
	                            </div>
						    ...
						    <div class="app-card-body p-3 has-card-actions">
							    ...
							    <h4 class="app-doc-title truncate mb-0"><a href="#file-link">{{$course->course_title}}</a></h4>
							    <div class="app-doc-meta">
								    <ul class="list-unstyled mb-0">
									    <li><span class="text-muted">Type:</span>{{$course->cat->category ?? 'None' }}</li>
									    <li><span class="text-muted">Size:</span> {{$course->price}} </li>
									    <li><span class="text-muted">Uploaded:</span>{{$course->created_at}}</li>
								    </ul>
							    </div><!--//app-doc-meta-->
							    ...
							    <div class="app-card-actions">
								    <div class="dropdown">
									    ...
									    <ul class="dropdown-menu">
										    <li><button class="dropdown-item" href=""  value="{{$course->id}}" id="viewCourse">
											...
											<li><button class="dropdown-item" href="#" value="{{$course->id}}" id="edit_course">
											...
											<li><button class="dropdown-item" href="#" value="{{$course->id}}" id="delete_course">
		...
		@include('cube.modal_includes.course_modal')
@endsection
